USE [master]
GO
/****** Object:  Database [sheep]    Script Date: 9/30/2021 7:18:32 PM ******/
...
USE [sheep]
GO
/****** Object:  Schema [ActiveHerd]    Script Date: 9/30/2021 7:18:32 PM ******/
CREATE SCHEMA [ActiveHerd]
GO
/****** Object:  Table [ActiveHerd].[breed]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [ActiveHerd].[breed](
	...
	[BreedDescription] [varchar](600) NULL,
...
GO
/****** Object:  Table [ActiveHerd].[injectionList]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [ActiveHerd].[injectionList](
	[InjectionType] [varchar](14) NOT NULL,
	[injectionDescription] [varchar](600) NULL,
PRIMARY KEY CLUSTERED 
(
	[InjectionType] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [ActiveHerd].[sheep]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [ActiveHerd].[sheepShots]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [ActiveHerd].[shepherd]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [ActiveHerd].[shotList]    Script Date: 9/30/2021 7:18:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [ActiveHerd].[shotList](
	[ShotType] [varchar](14) NOT NULL,
	[shotDescription] [varchar](600) NULL,
	[dayCycle] [int] NULL,
PRIMARY KEY CLUSTERED 
(
	[ShotType] ASC
...
GO
ALTER TABLE [ActiveHerd].[sheep]  WITH CHECK ADD  CONSTRAINT [Fk_BreedCategory1] FOREIGN KEY([BreedCategory])
REFERENCES [ActiveHerd].[breed] ([BreedCategory])
GO
ALTER TABLE [ActiveHerd].[sheep] CHECK CONSTRAINT [Fk_BreedCategory1]
GO
...
GO
ALTER TABLE [ActiveHerd].[sheepShots]  WITH CHECK ADD  CONSTRAINT [Fk_IdNum] FOREIGN KEY([IdNumber])
REFERENCES [ActiveHerd].[sheep] ([IdNumber])
GO
ALTER TABLE [ActiveHerd].[sheepShots] CHECK CONSTRAINT [Fk_IdNum]
GO
...
GO
ALTER TABLE [ActiveHerd].[sheepShots]  WITH CHECK ADD  CONSTRAINT [Fk_ShotType] FOREIGN KEY([ShotType])
REFERENCES [ActiveHerd].[shotList] ([ShotType])
GO
ALTER TABLE [ActiveHerd].[sheepShots] CHECK CONSTRAINT [Fk_ShotType]
GO
USE [master]
GO
